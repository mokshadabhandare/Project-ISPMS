			...
			<div class="markets-grids">
				<div class="col-md-3 col-sm-6 col-xs-6 w3ls-markets-grid text-center">
					<div class="agileits-icon-grid">
						...
						<div class="icon-right">
							<h5>Wifi</h5>
							<p>We are providing wifi with 50 mbps and 24*7 available feature</p>
						</div>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 w3ls-markets-grid text-center">
					<div class="agileits-icon-grid">
						...
						<div class="icon-right">
							<h5>Setting</h5>
							<p>Choose the Wifi network you want,then select Connect</p>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-6 w3ls-markets-grid text-center">
					<div class="agileits-icon-grid">
						...
						<div class="icon-right">
							<h5>Dth Plan</h5>
							<p>We are providing customize plans</p>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
					...
					<div class="col-md-7  col-sm-8 col-xs-8 wthree-offers-left">
						...
						<div class="offers-left-grids">
							...
							<div class="offers-text">
								<p>You can customise your dth plan</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="offers-left-grids offers-left-middle">
							...
							<div class="offers-text">
								<p>Dth hd box+antenna starting at Rs.400</p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="offers-left-grids">
							...
							<div class="offers-text">
								<p>Add 2 Dth connections at Rs.600</p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
